...
import { EllipsisVIcon, LockIcon, PlusCircleIcon } from "@patternfly/react-icons";
      ...
      <Card style={{ margin: "1.5em auto 2em", overflowY: "hidden" }}>
        ...
        <CardBody>
          <Panel style={{ margin: "0.75em auto" }}>
            <MultiContentCard cards={summaryCards} />
          </Panel>
                ...
                <DataListItemRow>
                  ...
                  <DataListItemCells
                    dataListCells={[
                      ...
                      <DataListCell key="">hashedrekord</DataListCell>,
                      <DataListCell key="">4 months ago </DataListCell>,
                      <DataListCell key="secondary content">Signature ✓ / Rekor ✓ / Chain ✓</DataListCell>,
                    ]}
                  />
