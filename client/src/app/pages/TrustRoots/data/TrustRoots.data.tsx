...
export const TUFMetadataStatus = {
  VALID: "valid",
  EXPIRING: "expiring",
};
...
export interface TrustRootEvents {
  timestamp: string;
  type: string;
  message: string;
}
...
export interface TrustRootKind {
  id: string;
  name: string;
  source: string;
  type: string;
...
export const exampleTrustRoots: TrustRootKind[] = [
  {
    ...
    tufMetadata: [
      {
        ...
        status: TUFMetadataStatus.VALID,
      },
      {
        role: "targets",
        version: 3,
      ...
      },
      {
        ...
        status: TUFMetadataStatus.EXPIRING,
      },
      {
        role: "timestamp",
        version: 12,
  ...
  {
    id: "root-2", // used internally or in dropdowns

    name: "Sigstore Dummy Root 2",
    source: "https://tuf-repo.sigstore.dev/",
    lastUpdated: "2025-06-09T08:43:00Z",
    type: "tuf", // could later support other types
  ...
  {
    id: "dummy-3", // used internally or in dropdowns
  ...
  {
    id: "example-4", // used internally or in dropdowns

    name: "Trust Root example 4",
    source: "https://tuf-repo.sigstore.dev/",
    lastUpdated: "2025-06-09T08:43:00Z",
    type: "tuf", // could later support other types
  ...
  {
    id: "dummy-5", // used internally or in dropdowns

    name: "Sigstore Dummy 5 Trust Root",
    source: "https://tuf-repo.sigstore.dev/",
    lastUpdated: "2025-06-09T08:43:00Z",
    type: "tuf", // could later support other types
