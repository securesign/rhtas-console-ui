...
// These were ripped from the PatternFly.org site.
const SunIcon = (
  <svg
    ...
    >
      <SelectGroup label={ColorSchemeGroupLabel}>
        <SelectList aria-labelledby="theme-selector-color-scheme-title">
          ...
          <SelectOption value={modes.LIGHT} icon={SunIcon} description="Always use light mode">
            Light
          </SelectOption>
          <SelectOption value={modes.DARK} icon={MoonIcon} description="Always use dark mode">
            Dark
          </SelectOption>
        </SelectList>
      </SelectGroup>
