  ...
  attestations: [
    {
      ...
      rekorEntry: {
        canonicalizedBody: "BASE64_BODY_ATT0",
        integratedTime: 1730883660,
        logId: { keyId: "d4c1a7f2-0000-0000-0000-000000000000" },
        logIndex: 2234,
        inclusionProof: {
          checkpoint: { envelope: "rekor.sigstore.dev - 223456" },
          hashes: ["att0a", "att0b"],
          logIndex: 2234,
          rootHash: "facefeed",
          treeSize: 123456,
        },
        inclusionPromise: { signedEntryTimestamp: "BASE64_SET_ATT0" },
      },
      type: "",
      rawBundleJson: "",
      rawStatementJson: "",
    ...
    },
    {
      ...
      rekorEntry: {
        canonicalizedBody: "BASE64_BODY_ATT1",
        integratedTime: 1730883720,
        logId: { keyId: "d4c1a7f2-0000-0000-0000-000000000000" },
        logIndex: 2235,
        inclusionProof: {
          checkpoint: { envelope: "rekor.sigstore.dev - 223457" },
          hashes: ["att1a", "att1b"],
          logIndex: 2235,
          rootHash: "beadfeed",
          treeSize: 123457,
        },
        inclusionPromise: { signedEntryTimestamp: "BASE64_SET_ATT1" },
      },
      type: "",
      rawBundleJson: "",
      rawStatementJson: "",
